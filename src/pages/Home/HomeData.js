...
export const homeObjThree= {
    ...
    topLine: "APPLY",
    rows: [0,2],
    title: ["Client Application","Student Application", "Student Application", "Student Application"],
    body: ["Are you a Non Profit Organization? Do you require any assistance? Please complete the below form and we'll get back to you ASAP!", "Are you a post-secondary student looking to gain more experience? Please apply below and we'll set up a meeting to talk about how you can contribute!","test","test"],
