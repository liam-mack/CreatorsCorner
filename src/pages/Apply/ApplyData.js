...
export const applyObjTwo = {
    ...
    body3:
      "To ensure success and that the products we deliver are up to standards, there is a very structured process that we follow. Typically, you can expect three-four meetings. These can include: an initial meeting to learn about client needs and communicate expectations, a second meeting for our team directors to get clarity and ask any pertinent questions, a third meeting halfway through our work to touchbase and resolve any conflicts, and a fourth meeting to finally handover the work.",
    body4: "Our process, training, and skills are formulated in a way to ensure the best possible outcome for our clients. The meetings and emails are our way of ensuring that we deliver YOUR vision and work WITH you. Our executive team works hard to train our students and teach them how to work with clients in a professional setting",
      headers: ["Do I need to pay for services? Why not?", "What are the services you offer?","What is the process of this organization?","What is the client-club interaction like?"],
  };
export const applyObjThree = {
    ...
    body3:
      "There are club/team meetings weekly, and then any additional meetings between teammates at their own discretion.",
      body4:"We expect about 2-5 hours of work every week.",
    headers: ["What are the expectations as a team member?", "How does the club operate?","How often do members meet?","What is the time commitment?", "Does this count as a CCR credit?"],
  };
...
export const applyObjFour = {
    ...
    body3:
      "As any extracurriculars. especially one of this caliber, we understand that we're asking a lot out of members. We strive to create an environment where our members don't feel like they're working, but we hope everyone will work hard.",
      body4:"Doing pro-bono work can sometimes seem hard to comprehend, and we understand that we're asking for free labour. We specially pick our clients based off the work that they're doing, which makes our which seem a little more special. We are passionate about making the world a better place, and we hope you are too.",
