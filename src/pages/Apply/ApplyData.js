...
export const applyObjThree = {
  ...
  body5:
    "We are currently trying to get our club approved by Carleton University!",
  headers: [
...
export const applyObjFour = {
  ...
  body4:
    "Doing pro-bono work can sometimes seem hard to comprehend, and we understand that we're asking for free labour. We specially pick our clients based off the work that they're doing, which makes our which seem a little more special. We are passionate about making the world a better place, and we hope you are too.",
